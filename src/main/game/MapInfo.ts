...
export class MapInfo {
    ...
    private constructor(
        ...
        tileset: number,
        randomMonsterTypes: number,
        maxRandomEncounters: number,
        borderTile: number,
        timePerStep: number,
        healRate: number,
        combatStringIDs: number[]
    ) {
        ...
        this.combatStringIDs = combatStringIDs;
    }
     ...
     *
     * @returns The random encounter frequency.
     */
     ...
     *
     * @returns The tileset to use to display the map.
     */
     ...
     *
     * @returns The number of used random monster types.
     */
     ...
     *
     * @returns How many random encounters can be on the map at once.
     */
     ...
     *
     * @returns The tile with which the frame around the map is filled.
     */
     ...
     *
     * @returns The time that passes on each step.
     */
     ...
     * point).
     *
     * @returns How quickly you heal over time.
     */
