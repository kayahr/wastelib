 ...
 */
export function decodeVxor(data: ArrayLike<number>, width: number, size: number, offset: number = 0): Uint8Array {
 ...
 */
export function decodeVxorInplace(data: Uint8Array, width: number, size: number, offset: number = 0): Uint8Array  {
